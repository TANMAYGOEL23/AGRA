#!/usr/bin/env python3
"""
Interactive Simulation Runner with Live Visualization and Telemetry HUD.
Supports switching scenarios, collision avoidance algorithms, and communication channels.
"""
import sys
import os
import argparse
...
def get_channel(name: str):
    ...
    elif name == "mesh" or name == "802.11p":
...
def main():
    ...
    parser.add_argument("--scenario", "-s", type=str, default="e4", help="Scenario preset: s1, s2, s3, formation, e1, e2, e3, e4")
    parser.add_argument("--controller", "-c", type=str, default="acact", help="Avoidance controller: apf, adaptive_apf, dynamic_apf, acact")
    parser.add_argument("--channel", "-n", type=str, default="dcacs", help="Communication channel: ideal, lossy, dcacs, mesh")
